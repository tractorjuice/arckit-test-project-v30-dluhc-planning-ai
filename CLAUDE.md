...
This is an **ArcKit architecture governance project** — not a software codebase. It generates architecture documents (markdown) for the **Planning & Housing Data Intelligence Platform** at Department for Levelling Up, Housing and Communities.
...
Expected artifacts for project 001 (Planning & Housing Data Intelligence Platform):
...
The Department for Levelling Up, Housing and Communities (DLUHC) drives the levelling up agenda, housing delivery, and local government policy. The planning system processes hundreds of thousands of applications annually, housing delivery targets require data-driven monitoring, and levelling up metrics need real-time tracking. AI can transform planning efficiency, housing intelligence, and community investment decisions.

### Compliance Context

UK Government ministerial department. Applicable frameworks: GDS Service Standard, Technology Code of Practice (TCoP), NCSC Cyber Assessment Framework, ATRS for AI tools, UK GDPR, HM Treasury Green Book, AI Playbook, Levelling Up and Regeneration Act 2023.

### Key Stakeholders

DLUHC (policy owner), local authorities (planning authorities), Homes England, Planning Inspectorate, Royal Town Planning Institute, house builders, housing associations, community groups, LGA.
